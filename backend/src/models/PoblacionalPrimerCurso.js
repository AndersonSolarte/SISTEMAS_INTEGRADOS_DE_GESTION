...
const PoblacionalPrimerCurso = sequelize.define('poblacional_primer_curso', {
  ...
  pueblo_indigena: { type: DataTypes.STRING(120), allowNull: true },
  comunidad_negra: { type: DataTypes.STRING(120), allowNull: true },
  capacidad_excepcional: { type: DataTypes.STRING(120), allowNull: true },
...
module.exports = PoblacionalPrimerCurso;
